    ...
    return(
        <AuthLayout>
            ...
            <Text
                ...
                value="Kindly Login to your account"
            />
            ...
            <div>
            {
                LoginStatus ==="pending"?(
                    ...
                    <button
                        type="submit"
                        data-te-ripple-init
                        className=" bg-purple w-full text-center px-6 pb-2.5 pt-4 my-3 text-sm font-medium leading-normal text-white inline-block rounded-md leading-normal">
                            Login
                    </button>
                )
            }
